...
import ru.webanimal.academy_lessons.data.models.Category;
import ru.webanimal.academy_lessons.data.models.DigestItem;

public class DataUtils {

    public static List<DigestItem> generateNews() {
        ...
        news.add(new DigestItem(
                "Умер последний самец белого носорога. Но ученые могут возродить исчезнувший вид",
                "https://mydiscoveries.ru/wp-content/uploads/2018/03/belyiy-nosorog-e1522351218776.jpg",
                animals,
                createDate(2018, 10, 14, 9, 4),
                "В марте 2018 года в почтенном возрасте 45-ти лет умер последний самец северного белого носорога по кличке Судан." +
                        " Он прожил счастливую, долгую и сытую жизнь, оставив после себя дочь по имени Наджин и внучку Фату." +
                        " На всей планете осталось всего два представителя этого вида.",
                "В марте 2018 года в почтенном возрасте 45-ти лет умер последний самец северного белого носорога по кличке Судан." +
                        " Он прожил счастливую, долгую и сытую жизнь, оставив после себя дочь по имени Наджин и внучку Фату." +
                        " На всей планете осталось всего два представителя этого вида.\n\n" +
                        "Судьба белых носорогов — прекрасная иллюстрация опустошающей деятельности человека." +
                        " Еще в начале 20 века на просторах Африки и Азии обитало около полумиллиона северных белых носорогов." +
                        " Неконтролируемая застройка на местах их обитания, загрязнение окружающей среды и браконьерство ради рогов привели" +
                        " к печальному итогу: на Земле остались всего 2 особи северного подвида белых носорогов.\n\n" +
                        "Потеряли ли мы белого носорога навсегда? Оказывается, надежда на возрождение северного белого носорога сохраняется." +
                        " Ученые успели собрать генетический материал Судана, с помощью которого они планируют оплодотворить двух оставшихся самок." +
                        " Подобная операция требует больших денежных затрат, поэтому в настоящее время идет сбор средств для ее осуществления."
        ));
        news.add(new DigestItem(
